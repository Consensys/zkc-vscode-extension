...
[ZkC](https://github.com/Consensys/go-corset/blob/main/ZKC_LANGUAGE.md)
...
release](https://github.com/Consensys/zkc-vscode-extension/releases).
...
1. Download the `.vsix` file from the [latest
   release](https://github.com/Consensys/zkc-vscode-extension/releases/latest).

2. Open VS Code.

3. Open the Extensions view (`Ctrl+Shift+X` / `Cmd+Shift+X`).

4. Click the `...` menu (top-right of the Extensions panel) and select
   **Install from VSIX...**.
